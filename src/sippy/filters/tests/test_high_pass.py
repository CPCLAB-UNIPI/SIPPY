...
class TestHighPassFilter:
    ...
    def test_high_pass_basic(self):
        ...
        assert filtered_rms < original_rms * 0.5, "High-pass filter didn't sufficiently reduce low-frequency components"
    ...
    def test_edge_cases(self):
        ...
        pd.DataFrame({'x': [1, 2, 3]}, index=pd.date_range('2023-01-01', periods=3, freq='1D'))
