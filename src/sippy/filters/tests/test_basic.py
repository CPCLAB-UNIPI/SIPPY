...
class TestFilterFactory:
    ...
    def test_list_filters(self):
        ...
        expected = ['highpass', 'high_pass', 'difference', 'doubledifference', 'diff', 'zeromean', 'zero_mean', 'none', 'passthrough']
        filters = FilterFactory.list_filters()
        
        for expected_filter in expected:
            assert expected_filter in filters, f"Filter '{expected_filter}' not found in {filters}"
