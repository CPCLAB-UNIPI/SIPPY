...
class TestExamples:
    ...
    def test_ex_armax_mimo(self):
        ...
        try:
            os.chdir(current_dir)
            import Ex_ARMAX_MIMO  # type: ignore
        except Exception as e:
    ...
    def test_ex_arx_mimo(self):
        ...
        try:
            os.chdir(current_dir)
            import Ex_ARX_MIMO  # type: ignore
        except Exception as e:
    ...
    def test_ex_recursive(self):
        ...
        try:
            os.chdir(current_dir)
            import Ex_RECURSIVE  # type: ignore
        except Exception as e:
    ...
    def test_ex_opt_gen_inout(self):
        ...
        try:
            ...
            spec = importlib.util.spec_from_file_location(
                "Ex_OPT_GEN_INOUT", 
                current_dir / "Ex_OPT_GEN-INOUT.py"
            )
