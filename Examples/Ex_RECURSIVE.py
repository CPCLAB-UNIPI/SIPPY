...
if mode == 'IC':
    ...
    Id_ARMAX = system_identification(Ytot, Usim, 'ARMAX', IC='AIC', na_ord=[4, 4], nb_ord=[3, 3], nc_ord=[2, 2], delays=[11, 11], max_iterations=300, ARMAX_mod = 'RLLS')
    
    Id_ARX = system_identification(Ytot, Usim, 'ARX', IC='AICc', na_ord=[4, 4], nb_ord=[3, 3], delays=[11, 11], max_iterations=300, ARX_mod = 'RLLS')
    
    Id_OE = system_identification(Ytot, Usim, 'OE', IC='BIC', nb_ord=[3, 3], nf_ord=[4, 4], delays=[11, 11], max_iterations=300, OE_mod = 'RLLS')
      

elif mode == 'FIXED':
    # use fixed model orders
    
    na_ord = [4]; nb_ord = [[3]]; nc_ord = [2]; nf_ord = [4]; theta = [[11]]
    
    Id_ARMAX = system_identification(Ytot, Usim, 'ARMAX', ARMAX_orders = [na_ord, nb_ord, nc_ord, theta], max_iterations=300, ARMAX_mod = 'RLLS')
    
    Id_ARX = system_identification(Ytot, Usim, 'ARX', ARX_orders = [na_ord, nb_ord, theta], max_iterations=300, ARX_mod = 'RLLS')
    
    Id_OE = system_identification(Ytot, Usim, 'OE', OE_orders = [nb_ord, nf_ord, theta], max_iterations=300, OE_mod = 'RLLS')
