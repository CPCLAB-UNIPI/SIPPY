    ...
    if (IC == 'AIC' or IC == 'AICc' or IC == 'BIC') == False:
        ...
        if id_method == 'ARX':
            ...
            if (type(ARX_orders[0]) == list and type(ARX_orders[1]) == list and type(
                ...
                DENOMINATOR, NUMERATOR, G, H, Vn_tot = arxMIMO.ARX_MIMO_id(y, u, na, nb, theta,
                                                                           tsample)
                identified_system = arxMIMO.ARX_MIMO_model(na, nb, theta, tsample, NUMERATOR,
            ...
            if (type(ARMAX_orders[0]) == list and type(ARMAX_orders[1]) == list and type(
                ...
                identified_system = armaxMIMO.ARMAX_MIMO_model(na, nb, nc, theta, tsample,
        ...
        #                identified_system='None'
            ...
            A_K, C, B_K, D, K, A, B, x0, Vn = Parsim_methods.PARSIM_K(y, u, SS_f, SS_p,
                                                                      ...
                                                                      SS_PK_B_reval)
            identified_system = Parsim_methods.SS_PARSIM_model(A, B, C, D, K, A_K, B_K, x0, tsample,
                                                               Vn)
        ...
        if id_method == 'ARX':
            ...
            identified_system = arx.ARX_model(na, nb, theta, tsample, NUMERATOR, DENOMINATOR,
